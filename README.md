...
- [OmniPost](https://github.com/bakasa/omnipost) - Self-hosted AI content adaptation for TikTok, YouTube Shorts, and Instagram Reels. No OAuth required. Write once, get platform-native captions, titles, and hashtags. ([Demo](https://omnipost-production-38f9.up.railway.app), [Source Code](https://github.com/bakasa/omnipost)) `MIT` `Docker/Nodejs`
